...
# Sample ATA CSV data with known values
ATA_CSV_SAMPLE = (
    "2025-06-12 06:43:41;	1;100;0;	5;100;0;	9;100;1768;"
    "	12;100;25;	194;69;31;	197;100;0;\n"
    "2025-06-12 07:13:41;	1;100;0;	5;100;0;	9;100;1768;"
    "	12;100;25;	194;70;30;	197;100;0;\n"
    "2025-06-12 07:43:41;	1;100;0;	5;100;1;	9;100;1769;"
    "	12;100;25;	194;68;32;	197;100;0;"
)

# Sample NVMe CSV data with known values
# Sample NVMe CSV data with known values
NVME_CSV_SAMPLE = (
    "2025-06-12 06:43:41;	temperature;57;	available_spare;100%;"
    "	percentage_used;0%;	power_on_hours;1747;	unsafe_shutdowns;11;"
    "	media_and_data_integrity_errors;0;\n"
    "2025-06-12 07:13:41;	temperature;49;	available_spare;100%;"
    "	percentage_used;0%;	power_on_hours;1747;	unsafe_shutdowns;11;"
    "	media_and_data_integrity_errors;0;\n"
    "2025-06-12 07:43:41;	temperature;49;	available_spare;100%;"
    "	percentage_used;1%;	power_on_hours;1748;	unsafe_shutdowns;11;"
...
class TestATAParsing:
    ...
    def test_parse_ata_reallocated_sectors(self):
        ...
        df = parse_ata_csv(ATA_CSV_SAMPLE)
        health = analyze_ata_health(
            df, serial="TEST001", device_path="/dev/sda"
        )
...
class TestNVMeParsing:
    ...
    def test_parse_nvme_error_detection(self):
        ...
        df = parse_nvme_csv(NVME_CSV_SAMPLE)
        health = analyze_nvme_health(
            df, serial="TEST-NVME", device_path="/dev/nvme0"
        )
...
class TestHealthAnalysis:
    ...
    def test_temperature_max_24h(self):
        ...
        health_ata = analyze_ata_health(
            df_ata, serial="TEST", device_path="/dev/sda"
        )
        ...
        health_nvme = analyze_nvme_health(
            df_nvme, serial="TEST", device_path="/dev/nvme0"
        )
